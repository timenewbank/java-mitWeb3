 ...
 */
public class MitSyncing extends Response<MitSyncing.Result> {

    @Override
    @JsonDeserialize(using = MitSyncing.ResponseDeserialiser.class)
    public void setResult(MitSyncing.Result result) {
