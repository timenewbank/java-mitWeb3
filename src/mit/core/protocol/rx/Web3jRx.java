...
public interface Web3jRx {
     ...
     */
    Observable<Log> mitLogObservable(EthFilter ethFilter);
     ...
     *         blockchain
     */
    Observable<String> mitBlockHashObservable();
     ...
     */
    Observable<String> mitPendingTransactionHashObservable();
     ...
     */
    Observable<MitBlock> blockObservable(boolean fullTransactionObjects);
     ...
     */
    Observable<MitBlock> replayBlocksObservable(
     ...
     *                              in the {@link MitBlock} responses
     ...
     */
    Observable<MitBlock> catchUpToLatestBlockObservable(
     ...
     */
    Observable<MitBlock> catchUpToLatestAndSubscribeToNewBlocksObservable(
            DefaultBlockParameter startBlock, boolean fullTransactionObjects);
