...
import mit.abi.FunctionReturnDecoder;
...
import mit.core.tx.exceptions.ContractCallException;
import mit.core.tx.gas.ContractGasProvider;
import mit.core.tx.gas.StaticGasProvider;
...
public abstract class Contract extends ManagedTransaction {
    ...
    /**
     * @deprecated ...
     * @see mit.core.tx.gas.DefaultGasProvider
     */
    ...
    public boolean isValid() throws IOException {
        ...
        MitGetCode ethGetCode = web3j
                .mitGetCode(contractAddress, DefaultBlockParameterName.LATEST)
                .send();
    ...
    private List<Type> executeCall(
        ...
        mit.core.protocol.core.methods.response.MitCall ethCall = web3j.mitCall(
