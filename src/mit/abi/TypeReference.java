 ...
 */
public abstract class TypeReference<T extends mit.abi.datatypes.Type>
    ...
    public static <T extends mit.abi.datatypes.Type> TypeReference<T> create(Class<T> cls) {
    ...
    public abstract static class StaticArrayTypeReference<T extends mit.abi.datatypes.Type>
