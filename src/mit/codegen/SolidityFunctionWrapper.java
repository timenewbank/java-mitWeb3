...
import mit.abi.datatypes.generated.AbiTypes;
...
import mit.core.protocol.core.methods.response.AbiDefinition;
...
import mit.core.utils.Collection;
import mit.utils.Strings;
...
public class SolidityFunctionWrapper extends Generator {
    ...
    private void addAddressesSupport(TypeSpec.Builder classBuilder,
        ...
        if (addresses != null) {
            ...
            // See mit.tx.Contract#getStaticDeployedAddress(String)
    ...
    TypeSpec buildEventResponseObject(
            String className,
            List<mit.codegen.SolidityFunctionWrapper.NamedTypeName> indexedParameters,
            List<mit.codegen.SolidityFunctionWrapper.NamedTypeName> nonIndexedParameters) {

        TypeSpec.Builder builder = TypeSpec.classBuilder(className)
                .addModifiers(Modifier.PUBLIC, Modifier.STATIC);

        builder.addField(LOG, "log", Modifier.PUBLIC);
        for (mit.codegen.SolidityFunctionWrapper.NamedTypeName
    ...
    private static Class<?> getStaticArrayTypeReferenceClass(String type) {
        try {
            return Class.forName("mit.abi.datatypes.generated.StaticArray" + type);
